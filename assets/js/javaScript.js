...
$('.dropdown_container')
	.on('click', '.dropdown_button', function() {
        $(this).siblings('.dropdown_list').toggle();
	})
	.on('input', '.dropdown_search', function() {
    	var target = $(this);
        var dropdownList = target.closest('.dropdown_list');
